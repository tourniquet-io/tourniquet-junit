...
public final class NetworkUtils {
    ...
    /**
     * The port offset may be configured at system level using the system property {@code tourniquet.net.portOffset}.
     * The offset defines the range of port-numbers used for random port search. The default range is 1024-65535. Any
     * offset will increase the lower bound, but not the upper. For example, setting a port offset of 10000 will
     * result in a range of 11024-65535. The port offset is an atomic integer value that is initialized using the
     * system property (default is 0). It may be set during runtime by setting the value of the port offset directly.
     */
    public static final AtomicInteger PORT_OFFSET = new AtomicInteger(Integer.parseInt(System.getProperty(
            "tourniquet.net.portOffset",
            "0")));
    /**
     ...
     * system property {@code tourniquet.net.maxRetries}. The default value is 3. It may be modified at runtime by
     ...
     * always above 1024 to not collide with the standard ports below 1024. Further, the tourniquet system property for
     * defining an offset is applied. The default tourniquet offset is 0.
     *
